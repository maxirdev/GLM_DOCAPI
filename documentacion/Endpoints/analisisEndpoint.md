...
Esta guía explica cómo un agente debe reproducir el inventario de [endpoints.md](endpoints.md) a partir de [LPS_COM_v01.xpz](../recursos/LPS_COM_v01.xpz) y del proceso `APIGLM.APIGLMMain`.
...
5. El [catálogo de tipos GeneXus](../scripts/gx-object-type-catalog.json), que permite confirmar que el valor de `Object/@type` corresponde a `Procedure`.
